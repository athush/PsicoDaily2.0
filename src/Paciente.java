...
public class Paciente extends Usuario{
    ...
    public void MenuPaciente(ArrayList<Psicologo> psicologos, ArrayList<Consulta> consultas){
        ...
        do {
            ...
            System.out.println("[8] - Marcar consultas.");
            ...
            if(escolha == 1){
                ...
                this.marcarConsulta(null, consultas);
            }
            else if(escolha != -1){
    ...
    public void marcarConsulta(ArrayList<Paciente> listaPaciente, ArrayList<Consulta> consultas) {
        ...
        if(this.id_psico == "null") {
            System.out.println("Esse paciente não está vinculado a nenhum psicólogo");
        }
        else {
            System.out.println("Insira o id da consulta: ");
            String id_consulta = leitor.nextLine();

            Consulta consulta = new Consulta(id_paciente, this.id_psico, id_consulta);
            boolean flag = false;
            do {
